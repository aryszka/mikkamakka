...
(define (compile-application context proc args)
  (cond ((tail? context)
          ...
          (compile-write context "])"))
        (else
          (compile-write context "(function(){var ")
          (compile-write context (sysname context "$f"))
          (compile-write context "=")
          (compile-exp context proc)
          (compile-write context ";")
          (compile-write context (sysname context "$f"))
          ...
          (compile-write context (sysname context "$f"))
          (compile-write context ";return typeof ")
          (compile-write context (sysname context "$f"))
          (compile-write context "===\"function\"?")
          (compile-write context (sysname context "$f"))
          (compile-write context "(")
          (compile-parameters context args)
          (compile-write context "):env(\"apply\")(")
          (compile-write context (sysname context "$f"))
          (compile-write context ",env(\"list\")(")
          (compile-parameters context args)
          (compile-write context "));})()"))))
